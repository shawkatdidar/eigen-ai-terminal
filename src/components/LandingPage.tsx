      ...
      <main className="mx-auto max-w-4xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        <footer className="border-t border-[var(--color-border)] py-8">
          <p className="max-w-2xl text-[12px] leading-[1.7] text-[var(--color-text-muted)]">
            Eigen Terminal is public AI intelligence infrastructure for builders and agents. Signals are generated from automated collection and analysis and should be verified before serious decisions.
          </p>
        </footer>
      </main>
    </div>
