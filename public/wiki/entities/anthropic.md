...
| **Valuation** | $965B (Series H, UNVERIFIED — Brad Gerstner/TBPN, May 30; no Anthropic announcement) |
| **Revenue (ARR)** | ~$47B (May 30, UNVERIFIED — same source); $40B+ (May 17); $30B (April 2026, confirmed) |
| **Revenue growth** | 10x/year vs OpenAI's 3.4x/year (V-13) |
| **Key products** | Claude (Opus 4.8 [UNVERIFIED], Sonnet 4.6, Haiku 4.5), Claude Code, Cowork |
| **IPO status** | Confidential S-1 filed with SEC (June 1, 2026) — PRIMARY SOURCE: @AnthropicAI |
...
| 2026-06-02 | **Opus 4.8 released: 69.2% SWEBench Pro, reclaims coding lead; self-fork capability and dynamic parallel workflows in Claude Code** [UNVERIFIED — peterdiamandis YouTube, June 2 — single secondary source] — SWEBench Pro score of 69.2% would represent a ~5pp improvement over Opus 4.7 (64.3%) and a ~10pp gap over GPT-5.5. Self-fork enables Claude Code to branch its own execution into parallel agent subprocesses without external orchestration. Prior watchlist (May 31): Opus 4.8 deadline passed with no announcement; now appearing via secondary source. Holding [UNVERIFIED] until Anthropic primary announcement at anthropic.com/news. | significant [UNVERIFIED] | [peterdiamandis](youtube:aMyubFA106U) |
| 2026-06-02 | **Project Glasswing expands to critical infrastructure in 15 countries** [PRIMARY: anthropic.com/news/expanding-project-glasswing, June 2] — Glasswing (powered by Mythos) expanding beyond enterprise customers to national critical infrastructure operators in 15 countries. Production user feedback: "hundreds if not thousands of false positives" — suggesting real-world deployment challenges alongside the 90.6% true positive rate from May 22 lab assessment. | significant | [anthropic.com](https://www.anthropic.com/news/expanding-project-glasswing) |
| 2026-06-01 | **Confidential S-1 draft submitted to SEC — IPO process formally initiated** [PRIMARY SOURCE: @AnthropicAI, June 1] — Anthropic filed a confidential draft S-1 with the SEC under the JOBS Act confidential filing provision. This is the legally irreversible first step of the IPO process. Public filing required ≥15 days before roadshow. Resolves PRED-001 (Anthropic IPO by Dec 31, 2026) as CORRECT. Strengthens CONV-003 (AI IPO wave). | significant | [@AnthropicAI](https://x.com/AnthropicAI) |
| 2026-05-30 | **$65B Series H at $965B valuation; $47B ARR** [UNVERIFIED — TBPN/Brad Gerstner only, no Anthropic announcement] — Brad Gerstner (Altimeter Capital, Anthropic investor) on TBPN. ARR trajectory: $9B (end-2025) → $30B (Apr 2026) → $40B+ (May 17) → $47B (May 30). $965B valuation = 24× ARR multiple. No primary source. | notable (UNVERIFIED) | [TBPN](youtube:U3zeIQcJtB0) |
| 2026-05-22 | **Karpathy joining Anthropic confirmed (upgraded from UNVERIFIED)** — peterdiamandis podcast with Karpathy quoted directly: initiative is using Claude to accelerate Claude's own pre-training research. Aqua-hire of RSI (Recursive Self-Improvement) open-source project. Most prominent external hire since company founding. | significant | [peterdiamandis](youtube:kklrodAua_U) |
| 2026-05-22 | **Project Glasswing initial update: 90.6% true positive rate on 1,752 assessed vulnerabilities; 62.4% high/critical** — anthropic.com/research. Assessed by 6 independent security research firms. Production user report: "about 90% accurate, became essential in less than a week." Moves Glasswing from claimed capability to validated production performance. | significant | [anthropic.com](https://www.anthropic.com/research/glasswing-initial-update) |
| 2026-05-22 | **SpaceX S1 filing confirms Anthropic pays $1B+/month ($15B/year) for Colossus data centers** — Anthropic's compute infrastructure for model training runs entirely on SpaceX-owned facilities. The $15B/year commitment appears in a public SEC document — the most credible evidence yet of Anthropic's infrastructure scale. | significant | [SEC/TBPN](youtube:OWT9LF8bVE0) |
| 2026-05-20 | **Claude self-hosted sandboxes (public beta) + MCP tunnels (research preview)** — @claudeai confirmed. Claude can now run in user-controlled sandboxes and connect to external tools via MCP tunnels without going through Anthropic's infrastructure. Expands Claude deployment surface for enterprise/security-sensitive environments. | notable | [@claudeai] |
| 2026-05-20 | **Andrej Karpathy joins Anthropic — aqua-hire for RSI open-source auto-research project** [UNVERIFIED — TBPN podcast only] — Karpathy's RSI project (recursive self-improvement / automated research) reportedly acquired alongside him joining Anthropic. Would be one of the highest-profile researcher moves of 2026. No primary source found. | notable (UNVERIFIED) | [TBPN podcast] |
| 2026-05-18 | **Acquires Stainless API — SDK and MCP server platform that powered every Anthropic SDK** — @AnthropicAI official announcement. Stainless built all Anthropic SDKs (Python, TS, Go, Java) and generates MCP server code. Acquisition gives Anthropic first-party control of the developer tooling layer: SDK updates can now ship in parallel with spec changes. Second acquisition in 6 weeks (Coefficient Bio ~$400M, April 3). First developer-infrastructure-focused acquisition. See [[ai-infrastructure]] and [[ai-business-funding]]. | significant | [@AnthropicAI](https://x.com/AnthropicAI/status/2056419620643541012) |
