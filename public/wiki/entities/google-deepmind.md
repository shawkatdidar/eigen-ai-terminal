...
|------|--------|-------------|--------|
| 2026-05-25 | **AlphaProof Nexus: agentic formal proof search framework, powered by Gemini, solves 9 open Erdős problems** — @pushmeet (Pushmeet Kohli, Google DeepMind). AI agent searches for formal proofs in Lean theorem prover. Applied to open formal math problems, autonomously solved 9 Erdős problems with machine-verified proofs. Follows AI Co-Mathematician (May 8, informal proofs) — this produces formally verified, objectively correct proofs. | significant | [@pushmeet](https://x.com/pushmeet/status/2058936037754224998) |
| 2026-05-23 | **Gemini 3.5 Pro roadmap confirmed (June 2026); AI Studio native Android app creation without code** — Logan Kilpatrick (Google AI Studio). 3.5 Flash positioned as "Sonnet-level" via distillation; 3.5 Pro is the next tier, expected June. AI Studio now creates native Android apps from natural language, targeting "software creators" without coding background. | notable | [GregIsenberg](youtube:e5GMR2XdSjc) |
| 2026-05-20 | **Google I/O: Gemini 3.5 Flash — 4× speed, $1.50/$9.00/1M tokens; Gemini Omni (video from any input); SynthID cross-industry watermarking standard** — Google I/O 2026. Gemini 3.5 Flash: 600–1,400 tok/s on TPU 8i, 4× faster than comparable frontier models; "frontier-level performance at flash speed." Priced $1.50/$9.00 per 1M input/output (3.6× more than Gemini 2.5 Flash per output token — premium for speed). Google token generation: 7× YoY. Gemini Omni: multimodal-to-video generation from any input modality. SynthID: AI content watermarking standard adopted by Google, OpenAI, ElevenLabs, NVIDIA (11+ companies) — moves from Google-proprietary to cross-industry standard. | significant | [blog.google](https://blog.google/technology/ai/google-io-2026/) |
| 2026-05-08 | **AI Co-Mathematician — 48% FrontierMath Tier 4 (new SOTA across all AI systems)** — Multi-agent system for open-ended research mathematics. Covers ideation, literature search, computational exploration, theorem proving, and theory building. Arxiv 2605.06651. Early tests helped researchers solve open problems. Announced by Pushmeet Kohli (@pushmeet). → DeepMind's first publicly claimed AI system that contributes to frontier mathematical research, not just automates existing workflows. | significant | [arxiv](https://arxiv.org/abs/2605.06651) |
